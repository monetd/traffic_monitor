...
function colorChange(str) {
	...
	if ( str.endsWith("bps") ) {
		...
		if( str.endsWith("Gbps") ) {
			newStr = "<font color=\'orange\'>" + str.substring(0,str.indexOf(" Gbps")) + "</font>Gbps";
		} else if( str.endsWith("Mbps") ) {
			newStr = "<font color=\'green\'>" + str.substring(0,str.indexOf(" Mbps")) + "</font>Mbps";
		} else if( str.endsWith("Kbps") ) {
			newStr = "<font color=\'green\'>" + str.substring(0,str.indexOf(" Kbps")) + "</font>Kbps";
		} else
			newStr = "<font color=\'green\'>" + str.substring(0,str.indexOf(" bps")) + "</font>bps";		
	} else {
		// PPS
		if( str.endsWith("Mpps") ) {
			newStr = "<font color=\'red\'>" + str.substring(0,str.indexOf(" Mpps")) + "</font>Mpps";
		} else if( str.endsWith("Kpps") ) {
			newStr = "<font color=\'green\'>" + str.substring(0,str.indexOf(" Kpps")) + "</font>Kpps";
		} else
			newStr = "<font color=\'green\'>" + str.substring(0,str.indexOf(" pps")) + "</font>pps";	
	}
